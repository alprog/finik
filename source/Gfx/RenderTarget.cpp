...
void RenderTarget::resize(SurfaceResolution resolution)
{
    ...
    engine.getDevice()->CreateRenderTargetView(internalResource, nullptr, handle.getCPU());
    engine.getDevice()->CreateShaderResourceView(internalResource, nullptr, textureHandle.getCPU());
}
