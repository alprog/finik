...
void SceneView::draw_content()
{
    ...
    D3D12_GPU_DESCRIPTOR_HANDLE handle = UseDepth ? lane->getFrameBuffer().depthStencil->textureHandle.getGPU() : lane->getFrameBuffer().renderTargets[0]->textureHandle.getGPU();
